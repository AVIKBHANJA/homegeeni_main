            ...
            <form onSubmit={handleSearch} className="relative">
              ...
              <div className="flex items-center bg-gray-50 rounded-full shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-300">
                ...
                <Input
                  ...
                  type="text"
                  placeholder={
                    isSearchFocused ? "Type your search query..." : ""
                  }
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  onFocus={() => setIsSearchFocused(true)}
                  onBlur={() => setIsSearchFocused(false)}
                  className="flex-1 border-0 py-2 sm:py-3 px-0 bg-transparent focus-visible:ring-0 placeholder:text-gray-500 text-sm caret-gray-500"
                />
                {!searchQuery && !isSearchFocused && (
                  <div className="absolute inset-y-0 left-12 sm:left-20 flex items-center pointer-events-none">
                    <AnimatedTypingPlaceholder
                      ...
                      deletingSpeed={25}
                      pauseDuration={1200}
                      className="text-gray-500 text-sm truncate max-w-[200px] sm:max-w-full"
